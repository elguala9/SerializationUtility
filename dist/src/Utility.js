 ...
 */
export async function calculateHash(buffer, algorithm = 'SHA-256') {
 ...
 */
export function calculateHashSync(buffer, algorithm = 'SHA-256') {
...
*/
export function composeUint8Array(buffers) {
